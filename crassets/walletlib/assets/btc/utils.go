...
func (asset *Asset) CreateRPCClient() error {
	...
	if utils.GlobalItem.Testnet {
		port = beego.AppConfig.String("BTC_TESTNET_PORT")
		walletName = beego.AppConfig.String("BTC_SYSTEM_TESTNET_WALLET")
		walletPassphrase = beego.AppConfig.String("BTC_TESTNET_WALLET_PASSPHRASE")
		asset.ChainParam = &chaincfg.TestNet3Params
	} else {
		port = beego.AppConfig.String("BTC_MAINET_PORT")
		walletName = beego.AppConfig.String("BTC_SYSTEM_WALLET")
		walletPassphrase = beego.AppConfig.String("BTC_WALLET_PASSPHRASE")
		asset.ChainParam = &chaincfg.MainNetParams
	}

	host := beego.AppConfig.String("BTC_RPC_HOST")
	rpcUser := beego.AppConfig.String("BTC_RPC_USER")
	rpcPass := beego.AppConfig.String("BTC_RPC_PASS")
...
func (asset *Asset) GetSystemLabel() string {
	if utils.GlobalItem.Testnet {
		return beego.AppConfig.String("BTC_SYSTEM_TESTNET_LABEL")
	}
	return beego.AppConfig.String("BTC_SYSTEM_LABEL")
}
...
func (asset *Asset) SetSystemAddress() {
	systemAddress, _ := utils.GetSuperadminSystemAddress(assets.BTCWalletAsset.String())
